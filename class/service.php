...
class Service {
  ...
  static function itemToString($i, $item) {
    ...
    if ($_GET['nav'] == 'services') {
      ...
      $db = new Database();
      $db->connect();
      $db->select('favorite', '*', null, 'item_id=' . $item[$i]->getId() . ' AND item_type="service" AND account_id=' . $_SESSION['login']->getId(), null, null);
      $res = $db->getResult();
  ...
  static function itemDetailsToString($i, $item) {
    ...
    include 'model/service_reservation.php';
          ...
          <div class="modal-content">
            ...
            <div class="modal-body">
              ...
              <div class="caption">
                <p>Tulajdonos: ' . $item[$i]->getOwnerName() . '</p>
                <p>Helyszín: ' . $item[$i]->getVenueName() . '</p>
                <p>Ár: ' . $item[$i]->getPrice() . ' ' . $item[$i]->getPriceUnit() . ' / ' . $item[$i]->getTime() . ' ' . $item[$i]->getTimeUnit() . '</p>
