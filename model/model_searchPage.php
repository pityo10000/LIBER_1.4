...
if (isset($_POST['itemType'])) {
  switch ($_POST['itemType']) {
    case 'venue':
      ...
      $db = new Database();
      $db->connect();
      $db->select('venue', '*', null, 'name LIKE "%' . $_GET['keywords'] . '%"', null, null);
      $res = $db->getResult();
    ...
    case 'equipment':
      ...
      $db = new Database();
      $db->connect();
      $db->select('equipment', '*', null, 'name LIKE "%' . $_GET['keywords'] . '%"', null, null);
      $res = $db->getResult();
    ...
    case 'service':
      ...
      $db = new Database();
      $db->connect();
      $db->select('service', '*', null, 'name LIKE "%' . $_GET['keywords'] . '%"', null, null);
      $res = $db->getResult();
    ...
    case 'serviceProvider':
      ...
      $db = new Database();
      $db->connect();
      $db->select('account', '*', 'user, permission, company_profile', 'permission.permissionName = "service" AND account.user_id = user.id AND account.permission_id = permission.id AND account.company_profile_id = company_profile.id AND name LIKE "%' . $_GET['keywords'] . '%"', null, null);
      $res = $db->getResult();
      ...
      foreach ($res as $result) {
        ...
        array_push($item, new Account($result['id'], $user, $permission, $companyProfile));
    ...
    case 'organizer':
      ...
      $db = new Database();
      $db->connect();
      $db->select('account', '*', 'user, permission, company_profile', 'permission.permissionName = "organizer" AND account.user_id = user.id AND account.permission_id = permission.id AND account.company_profile_id = company_profile.id AND name LIKE "%' . $_GET['keywords'] . '%"', null, null);
      $res = $db->getResult();
